...
void main(int argc, char ** argv){
	...
	CreateTumblingRobot(NxVec3(-20.0f, 50.0f, 0.0f));
...
void CreateTumblingRobot(NxVec3 pos){
	...
	boxDesc.dimensions = NxVec3( 2.0f, 40.0f, 2.0f);
	boxDesc.localPose.t = NxVec3( 0, 40, 0);
	boxDesc.userData = (void *)size_t(40.0f);
	//Create Actor
	...
	pActor->userData = (void *)size_t((int)10);
	return;
	//TODO/////////////////////////////////////////////////////////////
}
	/**
